...
return {
  ...
  config = function()
    ...
    vim.keymap.set("n", "<leader>H", function() harpoon:list():append() end, { desc = "Harpoon add file" })
    vim.keymap.set("n", "<leader>h", function() harpoon.ui:toggle_quick_menu(harpoon:list()) end, { desc = "Harpoon toogle quick menu" })
